            ...
            try
            {
                ...
                var teachers = await _pegasusContext.Teacher
                    ...
                    .Select(q => new
                    {
                        ...
                        q.IrdNumber,q.IdType,IdPhoto=String.Format("{0}?{1}",q.IdPhoto,r.Next()),q.IdNumber,q.HomePhone,q.MobilePhone,q.Email,
                        Photo=String.Format("{0}?{1}",q.Photo,r.Next()),q.ExpiryDate,
